...
text = os.popen("commander tokendump --tokengroup znet --device efr32mg22")
...
text = os.popen("commander tokendump --tokengroup znet --token MFG_INSTALLATION_CODE --device efr32mg22").read().split("\n")
...
def replace(matchObj):
        ...
        print(text)
        text[1] = install_code.strip().upper()
        return ":".join(text) 
